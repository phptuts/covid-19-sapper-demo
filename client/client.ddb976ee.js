...
function create_fragment$1(ctx) {
	...
	let t4;
	let p;
	let t5_value = /*error*/ ctx[0].message + "";
	let t5;
	...
	return {
		...
		l(nodes) {
			const head_nodes = query_selector_all("[data-svelte=\"svelte-1flk9qr\"]", document.head);
		...
		p(ctx, [dirty]) {
			if (dirty & /*error*/ 1 && t5_value !== (t5_value = /*error*/ ctx[0].message + "")) set_data(t5, t5_value);
		},
		i: noop,
		o: noop,
		d(detaching) {
...
const components = [
	{
		js: () => import('./index.dcac1f15.js'),
		css: ["index.dcac1f15.css","client.ddb976ee.css","helpers.4a61a4e6.css"]
	},
	{
		js: () => import('./about.2cb8db61.js'),
		css: ["about.2cb8db61.css","client.ddb976ee.css"]
	},
	{
		js: () => import('./reset.45c12f4a.js'),
		css: ["reset.45c12f4a.css","client.ddb976ee.css"]
	},
	{
		js: () => import('./[country].b361e617.js'),
		css: ["[country].b361e617.css","client.ddb976ee.css","helpers.4a61a4e6.css"]
	}
];
...
const routes = (d => [
...

	{
		...
		pattern: /^\/([^\/]+?)\/?$/,
		parts: [
			{ i: 3, params: match => ({ country: d(match[1]) }) }
		]
	}
])(decodeURIComponent);
...
export { update_keyed_each as A, add_flush_callback as B, transition_in as C, transition_out as D, destroy_component as E, createEventDispatcher as F, destroy_block as G, add_render_callback as H, set_input_value as I, select_option as J, select_value as K, onMount as L, onDestroy as M, query_selector_all as N, set_style as O, goto as P, assign as Q, get_spread_update as R, SvelteComponent as S, get_spread_object as T, check_outros as U, group_outros as V, insert as a, element as b, space as c, detach as d, empty as e, claim_element as f, children as g, claim_space as h, init as i, attr as j, append as k, listen as l, is_function as m, noop as n, destroy_each as o, text as p, claim_text as q, run_all as r, safe_not_equal as s, toggle_class as t, set_data as u, binding_callbacks as v, bind as w, create_component as x, claim_component as y, mount_component as z };
