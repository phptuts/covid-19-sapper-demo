import { c as createCommonjsModule, _ as _typeof$2, a as _asyncToGenerator, b as _regeneratorRuntime, d as _inherits, e as _classCallCheck, i as init, s as safe_not_equal, f as _assertThisInitialized, S as SvelteComponent, g as empty, h as insert, j as detach, k as element, l as space, m as claim_element, n as children, o as claim_space, p as attr, t as toggle_class, q as append, r as run_all, u as listen, v as is_function, w as _slicedToArray, x as noop, y as destroy_each, z as _getPrototypeOf, A as _possibleConstructorReturn, B as text, C as claim_text, D as set_data, E as binding_callbacks, F as bind, G as create_component, H as claim_component, I as mount_component, J as update_keyed_each, K as add_flush_callback, L as transition_in, M as transition_out, N as destroy_component, O as createEventDispatcher, P as destroy_block, Q as add_render_callback, R as set_input_value, T as select_option, U as select_value, V as commonjsGlobal, W as commonjsRequire, X as onMount, Y as onDestroy } from './client.3a5ed47b.js';
import { s as saveCache, g as getCacheData, _ } from './cache.f43fff97.js';
 ...
 */
var countryMapping = [{
  possibleNames: ["us", "united states of america", "america", "united states"],
  standardizedName: "usa"
}, {
  possibleNames: ["south korea", "korea, south"],
  standardizedName: "s. korea"
}, {
  possibleNames: ["united kingdom", "england"],
  standardizedName: "uk"
}, {
  possibleNames: ["dr"],
  standardizedName: "dominican republic"
}, {
  possibleNames: ["united arab emirates"],
  standardizedName: "uae"
}, {
  possibleNames: ["bosnia and herzegovina"],
  standardizedName: "bosnia"
}, {
  possibleNames: ["virgin islands"],
  standardizedName: "u.s. virgin islands"
}, {
  possibleNames: ['Iran Islamic Republic Of'],
  standardizedName: 'iran'
}, {
  possibleNames: ["czech republic"],
  standardizedName: "czechia"
}, {
  possibleNames: ["méxico"],
  standardizedName: "mexico"
}, {
  possibleNames: ["brasil"],
  standardizedName: "brazil"
}, {
  possibleNames: ["panamá"],
  standardizedName: "panama"
}];
/**
...
function standardizeCountryName(countryName) {
  var possibleMapping = countryMapping.filter(function (mapping) {
    return mapping.possibleNames.indexOf(countryName) >= 0;
  });
...
var allCountryTimelineData = 'all_country_timeline_data';
var allCountriesDataCacheKey = 'all_country_data_cache_key';
var countryTimelineCacheKey = 'country_timeline_cache_key_';
var countryDataCacheKey = 'country_data_cache_key_';
var provinceCacheKey = 'province_cache_key';
var allWorldCacheKey = 'all_world_cache_key';
var getWorldStats = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            cachedData = getCacheData(allWorldCacheKey);
          ...
          case 3:
            _context.next = 5;
            return client.get('https://corona.lmao.ninja/all');
  ...
  return function getWorldStats() {
    return _ref.apply(this, arguments);
  };
}();
var getDataForCountries = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
    var cachedData, response, countriesData;
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            cachedData = getCacheData(allCountriesDataCacheKey);
          ...
          case 3:
            _context2.next = 5;
            return client.get('https://corona.lmao.ninja/countries');

          case 5:
            response = _context2.sent;
            countriesData = response.body.map(function (c) {
              var country = c.country; // Temp Fix
            ...
            return _context2.abrupt("return", countriesData);
  ...
  return function getDataForCountries() {
    return _ref2.apply(this, arguments);
  };
}();
var getProvincesForCountry = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return getDataProvinces();

          case 2:
            data = _context3.sent;
            return _context3.abrupt("return", data.filter(function (data) {
              return !_.isEmpty(data.province) && standardizeCountryName(data.country.toLowerCase()) === standardizeCountryName(country.toLowerCase()) && !data.province.toLowerCase().includes('princess') && !data.province.toLowerCase().includes('recovered');
            }).map(function (provinceData) {
              return {
  ...
  return function getProvincesForCountry(_x) {
    return _ref3.apply(this, arguments);
  };
}();
var getDataForCountry = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(country) {
    var cacheKey, cachedData, response;
    return _regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            cacheKey = countryDataCacheKey + country.toLowerCase();
          ...
          case 4:
            _context4.next = 6;
            return client.get('https://corona.lmao.ninja/countries/' + country.toLowerCase());
  ...
  return function getDataForCountry(_x2) {
    return _ref4.apply(this, arguments);
  };
}();
var getCountryTimeline = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            cacheKey = countryTimelineCacheKey + country.toLowerCase();
            cachedData = getCacheData(cacheKey);
          ...
          case 4:
            _context5.next = 6;
            return client.get('https://corona.lmao.ninja/v2/historical/' + country);
  ...
  return function getCountryTimeline(_x3) {
    return _ref5.apply(this, arguments);
  };
}();
var getWorldTimeline = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            _context6.next = 3;
            return getCountriesTimeline();

          case 3:
            countriesData = _context6.sent;
            return _context6.abrupt("return", countriesData.reduce(function (prev, countryData) {
              _.keys(countryData.timeline.deaths).forEach(function (key) {
                if (!prev.cases[key]) {
                  prev.cases[key] = 0;
                  prev.deaths[key] = 0;
                }
  ...
  return function getWorldTimeline() {
    return _ref6.apply(this, arguments);
  };
}();

var getDataProvinces = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.next = 2;
            return client.get('https://corona.lmao.ninja/v2/jhucsse');
  ...
  return function getDataProvinces() {
    return _ref7.apply(this, arguments);
  };
}();

var getCountriesTimeline = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            cachedData = getCacheData(allCountryTimelineData);
            ...
            return _context8.abrupt("return", cachedData);

          case 3:
            _context8.next = 5;
            return client.get('https://corona.lmao.ninja/v2/historical');
  ...
  return function getCountriesTimeline() {
...
function create_if_block(ctx) {
  ...
  return {
    ...
    h: function h() {
      attr(i, "class", "item active svelte-9ck7p1");
    },
...
function create_fragment(ctx) {
  ...
  return {
    ...
    l: function l(nodes) {
      ...
      i0 = claim_element(span0_nodes, "I", {
        class: true
      });
      ...
      i1 = claim_element(span1_nodes, "I", {
        class: true
      });
    ...
    h: function h() {
      attr(i0, "class", "left chevron icon");
      attr(span0, "class", "icon item svelte-9ck7p1");
      toggle_class(span0, "disabled",
      /*shownPage*/
      ctx[2] === 1);
      attr(i1, "class", "right chevron icon");
      attr(span1, "class", "icon item svelte-9ck7p1");
      toggle_class(span1, "disabled",
      /*shownPage*/
      ctx[2] ===
      /*totalPages*/
      ctx[1]);
      attr(div, "class", "ui right floated pagination menu");
      attr(th, "colspan",
      /*colSpan*/
      ctx[0]);
    },
...
function doPaging(currentPage, maxPagesDisplayed, numberOfPages, startingPage) {
  ...
  if (currentPage < maxPagesDisplayed / 2 + 1) {
    ...
    startingPage = Math.floor(numberOfPages - maxPagesDisplayed + 1); // Don't go beyond the last page
  } else {
...
function instance($$self, $$props, $$invalidate) {
  var _$$props$colSpan = $$props.colSpan,
      colSpan = _$$props$colSpan === void 0 ? 9 : _$$props$colSpan;
  var _$$props$page = $$props.page,
      page = _$$props$page === void 0 ? 0 : _$$props$page;
  var _$$props$totalPages = $$props.totalPages,
      totalPages = _$$props$totalPages === void 0 ? 0 : _$$props$totalPages;

  function changePage(outputPage) {
    $$invalidate(5, page = outputPage - 1);
  }

  $$self.$set = function ($$props) {
    if ("colSpan" in $$props) $$invalidate(0, colSpan = $$props.colSpan);
  ...
  $$self.$$.update = function () {
    ...
    /*shownPage, totalPages*/
    6) {
       $$invalidate(3, pages = doPaging(shownPage, 5, totalPages, 1));
    }
  };

  return [colSpan, totalPages, shownPage, pages, changePage, page];
}

var TablePagination = /*#__PURE__*/function (_SvelteComponent) {
  _inherits(TablePagination, _SvelteComponent);
...
function create_each_block_2(ctx) {
  ...
  return {
    ...
    h: function h() {
      attr(th, "class", "svelte-1qiis82");
      toggle_class(th, "sorting",
      /*sortBy*/
      ctx[1] ===
      /*field*/
      ctx[16].toLowerCase());
...
function create_each_block_1(ctx) {
  ...
  ctx[13][
  /*field*/
  ctx[16].toLowerCase()].toLocaleString() + "";
  var t;
  return {
    c: function c() {
      td = element("td");
    ...
    p: function p(ctx, dirty) {
      ...
      ctx[13][
      /*field*/
      ctx[16].toLowerCase()].toLocaleString() + "")) set_data(t, t_value);
    },
    d: function d(detaching) {
      if (detaching) detach(td);
    }
  };
} // (65:6) {#each listShown as geo (geo.location)}


function create_each_block$1(key_1, ctx) {
  var tr;
  var td;
  var t0_value = _.startCase(locationChange(
  /*geo*/
  ctx[13].location)) + "";
  var t0;
  var t1;
  ...
  return {
    ...
    h: function h() {
      attr(tr, "class", "svelte-1qiis82");
      toggle_class(tr, "canNav",
      /*canNav*/
      ctx[3]);
      this.first = tr;
    },
    m: function m(target, anchor, remount) {
      ...
      dispose = listen(tr, "click", function () {
        ...
        ctx[13].location)))
          ...
          ctx[7](
          /*geo*/
          ctx[13].location).apply(this, arguments);
      });
    },
    p: function p(new_ctx, dirty) {
      ctx = new_ctx;
      if (dirty &
      /*listShown*/
      64 && t0_value !== (t0_value = _.startCase(locationChange(
      /*geo*/
      ctx[13].location)) + "")) set_data(t0, t0_value);
...
function create_fragment$1(ctx) {
  ...
  for (var _i5 = 0; _i5 < each_value.length; _i5 += 1) {
    var child_ctx = get_each_context$1(ctx, each_value, _i5);
    var key = get_key(child_ctx);
    each1_lookup.set(key, each_blocks[_i5] = create_each_block$1(key, child_ctx));
  }

  function tablepagination_totalPages_binding(value) {
    /*tablepagination_totalPages_binding*/
    ctx[11].call(null, value);
  }

  function tablepagination_page_binding(value) {
    /*tablepagination_page_binding*/
    ctx[12].call(null, value);
  }

  var tablepagination_props = {};

  if (
  /*totalPages*/
  ctx[5] !== void 0) {
    tablepagination_props.totalPages =
    /*totalPages*/
    ctx[5];
  }
  ...
  /*page*/
  ctx[0] !== void 0) {
    tablepagination_props.page =
    /*page*/
    ctx[0];
  }

  var tablepagination = new TablePagination({
    props: tablepagination_props
  });
  binding_callbacks.push(function () {
    return bind(tablepagination, "totalPages", tablepagination_totalPages_binding);
  });
  binding_callbacks.push(function () {
    return bind(tablepagination, "page", tablepagination_page_binding);
  });
  return {
    c: function c() {
      div = element("div");
      ...
      t3 = space();
      create_component(tablepagination.$$.fragment);
      this.h();
    },
    l: function l(nodes) {
      ...
      for (var _i9 = 0; _i9 < each_blocks.length; _i9 += 1) {
        each_blocks[_i9].l(tbody_nodes);
      }

      tbody_nodes.forEach(detach);
      t3 = claim_space(table_nodes);
      claim_component(tablepagination.$$.fragment, table_nodes);
    ...
    h: function h() {
      attr(th, "class", "svelte-1qiis82");
      attr(table, "class", "ui celled table");
    ...
    m: function m(target, anchor) {
      ...
      append(table, t3);
      mount_component(tablepagination, table, null);
      current = true;
    },
    p: function p(ctx, _ref) {
      ...
      6) {
        ...
        for (_i12 = 0; _i12 < each_value_2.length; _i12 += 1) {
          var _child_ctx = get_each_context_2(ctx, each_value_2, _i12);

          if (each_blocks_1[_i12]) {
            each_blocks_1[_i12].p(_child_ctx, dirty);
          } else {
            each_blocks_1[_i12] = create_each_block_2(_child_ctx);

            each_blocks_1[_i12].c();

            each_blocks_1[_i12].m(tr, null);
          }
        }
      ...
      if (dirty &
      /*canNav, onSelectedLocation, listShown, fields, _, locationChange*/
      204) {
        var _each_value =
        /*listShown*/
        ctx[6];
        each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, _each_value, each1_lookup, tbody, destroy_block, create_each_block$1, null, get_each_context$1);
      }

      var tablepagination_changes = {};

      if (!updating_totalPages && dirty &
      /*totalPages*/
      32) {
        updating_totalPages = true;
        tablepagination_changes.totalPages =
        /*totalPages*/
        ctx[5];
        add_flush_callback(function () {
          return updating_totalPages = false;
        });
      }
      ...
      tablepagination.$set(tablepagination_changes);
    },
    i: function i(local) {
      if (current) return;
      transition_in(tablepagination.$$.fragment, local);
      current = true;
    },
    o: function o(local) {
      transition_out(tablepagination.$$.fragment, local);
      current = false;
    },
    d: function d(detaching) {
      ...
      destroy_component(tablepagination);
    }
  };
}
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  var _$$props$sortBy = $$props.sortBy,
      sortBy = _$$props$sortBy === void 0 ? "none" : _$$props$sortBy;
  var _$$props$page = $$props.page,
      page = _$$props$page === void 0 ? 0 : _$$props$page;
  var fields = $$props.fields;
  var _$$props$canNav = $$props.canNav,
      canNav = _$$props$canNav === void 0 ? false : _$$props$canNav;
  var _$$props$geoRegionNam = $$props.geoRegionName,
      geoRegionName = _$$props$geoRegionNam === void 0 ? "Country" : _$$props$geoRegionNam;
  ...
  function tablepagination_totalPages_binding(value) {
    totalPages = value;
    ($$invalidate(5, totalPages), $$invalidate(8, list)), $$invalidate(1, sortBy);
  }
  ...
  $$self.$set = function ($$props) {
    ...
    if ("canNav" in $$props) $$invalidate(3, canNav = $$props.canNav);
    if ("geoRegionName" in $$props) $$invalidate(4, geoRegionName = $$props.geoRegionName);
  };
  ...
  $$self.$$.update = function () {
    ...
    /*sortBy*/
    2) {
       $$invalidate(8, list = sortList(sortBy));
    }

    if ($$self.$$.dirty &
    /*list*/
    256) {
       $$invalidate(5, totalPages = Math.ceil(list.length / pageSize));
    }

    if ($$self.$$.dirty &
    /*list, page*/
    257) {
       $$invalidate(6, listShown = list.slice(page * pageSize, page * pageSize + pageSize));
    }
  };

  return [page, sortBy, fields, canNav, geoRegionName, totalPages, listShown, onSelectedLocation, list, dispatch, sortList, tablepagination_totalPages_binding, tablepagination_page_binding];
}
...
function get_each_context$2(ctx, list, i) {
  ...
  child_ctx[6] = list[i];
  return child_ctx;
} // (23:10) {#each selectFields as field}
...
function create_fragment$2(ctx) {
  ...
  return {
    ...
    l: function l(nodes) {
      ...
      t3 = claim_text(label1_nodes, "Sort By");
      ...
      var option_nodes = children(option);
      t5 = claim_text(option_nodes, "None");
      option_nodes.forEach(detach);
    ...
    h: function h() {
      ...
      attr(input, "placeholder", input_placeholder_value = "Enter " +
      /*geoRegionName*/
      ctx[2]);
      attr(div0, "class", "field");
      option.__value = "none";
      option.value = option.__value;
      attr(select, "class", "ui dropdown");
      if (
      /*sortBy*/
      ...
      attr(div2, "class", "two fields");
      attr(form, "class", "ui form");
    ...
    p: function p(ctx, _ref) {
      ...
      if (dirty &
      /*geoRegionName*/
      4 && input_placeholder_value !== (input_placeholder_value = "Enter " +
      /*geoRegionName*/
      ctx[2])) {
...
function instance$2($$self, $$props, $$invalidate) {
  var _$$props$sortBy = $$props.sortBy,
      sortBy = _$$props$sortBy === void 0 ? "none" : _$$props$sortBy;
  var _$$props$search = $$props.search,
      search = _$$props$search === void 0 ? "" : _$$props$search;
  var _$$props$geoRegionNam = $$props.geoRegionName,
      geoRegionName = _$$props$geoRegionNam === void 0 ? "Country" : _$$props$geoRegionNam;
  var selectFields = $$props.selectFields;
  ...
  function select_change_handler() {
    ...
    $$invalidate(0, sortBy);
    $$invalidate(3, selectFields);
  }

  $$self.$set = function ($$props) {
    if ("sortBy" in $$props) $$invalidate(0, sortBy = $$props.sortBy);
    if ("search" in $$props) $$invalidate(1, search = $$props.search);
    if ("geoRegionName" in $$props) $$invalidate(2, geoRegionName = $$props.geoRegionName);
    if ("selectFields" in $$props) $$invalidate(3, selectFields = $$props.selectFields);
  };

  return [sortBy, search, geoRegionName, selectFields, input_input_handler, select_change_handler];
}

var Filter = /*#__PURE__*/function (_SvelteComponent) {
  _inherits(Filter, _SvelteComponent);

  var _super = _createSuper$2(Filter);
  ...
  (function (global, factory) {
      ...
      return extend(function () {
        ...
        if (firstTime) {
          ...
          for (var i = 0; i < arguments.length; i++) {
            ...
            if (_typeof$2(arguments[i]) === 'object') {
              arg += '\n[' + i + '] ';
    ...
    function createDuration(input, key) {
      ...
      if (isDuration(input)) {
        ...
        duration = {};
      } else if (_typeof$2(duration) === 'object' && ('from' in duration || 'to' in duration)) {
    ...
    */
    ...
    var exports$1 = {
      ...
      drawPoint: function drawPoint(ctx, style, radius, x, y, rotation) {
        ...
        if (style && _typeof$2(style) === 'object') {
          type = style.toString();
    ...
    function interpolate(start, view, model, ease) {
      ...
      for (i = 0, ilen = keys.length; i < ilen; ++i) {
        ...
        origin = start[key];
        type = _typeof$2(target);

        if (type === _typeof$2(origin)) {
          if (type === 'string') {
    ...
    var controller_bubble = core_datasetController.extend({
      ...
      updateElement: function updateElement(point, index, reset) {
        ...
        var x = reset ? xScale.getPixelForDecimal(0.5) : xScale.getPixelForValue(_typeof$2(data) === 'object' ? data : NaN, index, dsIndex);
    ...
    var controller_line = core_datasetController.extend({
      ...
      updateElement: function updateElement(point, index, reset) {
        ...
        x = xScale.getPixelForValue(_typeof$2(value) === 'object' ? value : NaN, index, datasetIndex);
...
function instance$3($$self, $$props, $$invalidate) {
  var historicData = $$props.historicData;
  ...
  var createChart = function createChart() {
    chart = new Chart(lineChart.getContext("2d"), {
      ...
      data: {
        datasets: [{
          label: "Cases",
          data: _.keys(historicData.cases).map(function (key) {
            return {
              x: key,
              y: historicData.cases[key]
            };
          }),
          fill: false,
          ...
          label: "Deaths",
          data: _.keys(historicData.deaths).map(function (key) {
            return {
              x: key,
              y: historicData.deaths[key]
            };
          }),
          fill: false,
  ...
  return [lineChart, hideChart, historicData, title, chart, createChart, canvas_binding];
}

var CovidChart = /*#__PURE__*/function (_SvelteComponent) {
  _inherits(CovidChart, _SvelteComponent);

  var _super = _createSuper$3(CovidChart);

  function CovidChart(options) {
    var _this;

    _classCallCheck(this, CovidChart);
...
var filterByName = function filterByName(list, search) {
  if (search.length > 0) {
    return list.filter(function (c) {
      return c.location.toLowerCase().includes(search.toLowerCase());
    });
  }
...
export { CovidChart as C, Filter as F, Table as T, getWorldStats as a, getDataForCountries as b, getProvincesForCountry as c, getCountryTimeline as d, getDataForCountry as e, filterByName as f, getWorldTimeline as g };
