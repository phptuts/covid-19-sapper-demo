import { c as createCommonjsModule, _ as _typeof$2, a as _asyncToGenerator, b as _regeneratorRuntime, d as _inherits, e as _classCallCheck, i as init, s as safe_not_equal, f as _assertThisInitialized, S as SvelteComponent, g as empty, h as insert, j as detach, k as element, l as space, m as claim_element, n as children, o as claim_space, p as attr, t as toggle_class, q as append, r as run_all, u as listen, v as is_function, w as _slicedToArray, x as noop, y as destroy_each, z as _getPrototypeOf, A as _possibleConstructorReturn, B as text, C as claim_text, D as set_data, E as binding_callbacks, F as bind, G as create_component, H as claim_component, I as mount_component, J as update_keyed_each, K as add_flush_callback, L as transition_in, M as transition_out, N as destroy_component, O as createEventDispatcher, P as destroy_block, Q as add_render_callback, R as set_input_value, T as select_option, U as select_value, V as commonjsGlobal, W as commonjsRequire, X as onMount, Y as onDestroy } from './client.6812f81c.js';
import { s as saveCache, g as getCacheData, _ } from './cache.c7679f46.js';
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            return _context3.abrupt("return", data.filter(function (data) {
              return !_.isEmpty(data.province) && standardizeCountryName(data.country.toLowerCase()) === standardizeCountryName(country.toLowerCase()) && !data.province.toLowerCase().includes('princess');
...
function create_each_block_1(ctx) {
  ...
  ctx[12][
  /*field*/
  ctx[15].toLowerCase()].toLocaleString() + "";
  var t;
  return {
    c: function c() {
      td = element("td");
    ...
    p: function p(ctx, dirty) {
      ...
      ctx[12][
      /*field*/
      ctx[15].toLowerCase()].toLocaleString() + "")) set_data(t, t_value);
    },
    d: function d(detaching) {
      if (detaching) detach(td);
    }
  };
} // (60:6) {#each listShown as geo (geo.location)}
    ...
    m: function m(target, anchor, remount) {
      ...
      dispose = listen(tr, "click", function () {
        ...
        ctx[12].location)))
          ...
          ctx[7](
          /*geo*/
          ctx[12].location).apply(this, arguments);
      });
    },
    p: function p(new_ctx, dirty) {
      ctx = new_ctx;
      ...
      /*geo*/
      ctx[12].location)) + "")) set_data(t0, t0_value);
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  function tablepagination_totalPages_binding(value) {
    totalPages = value;
    $$invalidate(5, totalPages), $$invalidate(8, list);
  }
  ...
  $$self.$$.update = function () {
    ...
    66) {
       {
        if (sortBy !== "none") {
          $$invalidate(6, listShown = listShown.sort(function (a, b) {
  ...
  return [page, sortBy, fields, canNav, geoRegionName, totalPages, listShown, onSelectedLocation, list, dispatch, tablepagination_totalPages_binding, tablepagination_page_binding];
}
